...
static const char *www[] = { "firefox", "localhost:2987", NULL };
...
static Key keys[] = {
	...
	{ 0,              		XF86XK_AudioLowerVolume, spawn,                  SHCMD("pactl set-sink-mute 0 false ; pactl set-sink-volume @DEFAULT_SINK@ -10%") },
        { 0,              		XF86XK_AudioRaiseVolume, spawn,         	 SHCMD("pactl set-sink-mute 0 false ; pactl set-sink-volume @DEFAULT_SINK@ +10%") },
